...
ALTER TABLE         "iso"."continents" 
    ENABLE          ROW LEVEL SECURITY;

CREATE POLICY       "Users can read iso.continents"
    ON              "iso"."continents"
    AS              PERMISSIVE
    FOR             SELECT
    TO              "public"
...
ALTER TABLE         "iso"."countries" 
    ENABLE          ROW LEVEL SECURITY;

CREATE POLICY       "Users can read iso.countries"
    ON              "iso"."countries"
    AS              PERMISSIVE
    FOR             SELECT
    TO              "public"
...
ALTER TABLE         "iso"."cities" 
    ENABLE          ROW LEVEL SECURITY;

CREATE POLICY       "Users can read iso.cities"
    ON              "iso"."cities"
    AS              PERMISSIVE
    FOR             SELECT
    TO              "public"
...
CREATE POLICY       "Users can read iso.languages"
    ON              "iso"."languages"
    AS              PERMISSIVE
    FOR             SELECT
    TO              "public"
...
-------------------------------------------------------------------------------
-- CREATE TABLE "iso"."country_languages"
-------------------------------------------------------------------------------
CREATE TABLE 
...
ALTER TABLE         "iso"."country_languages" 
    ENABLE          ROW LEVEL SECURITY;

CREATE POLICY       "Users can read iso.country_languages"
    ON              "iso"."country_languages"
    AS              PERMISSIVE
    FOR             SELECT
    TO              "public"
    USING (
...
CREATE POLICY       "Users can read iso.currencies"
    ON              "iso"."currencies"
    AS              PERMISSIVE
    FOR             SELECT
    TO              "public"
...
-------------------------------------------------------------------------------
-- CREATE TABLE "iso"."country_currencies"
-------------------------------------------------------------------------------
CREATE TABLE 
...
ALTER TABLE         "iso"."country_currencies" 
    ENABLE          ROW LEVEL SECURITY;

CREATE POLICY       "Users can read iso.country_currencies"
    ON              "iso"."country_currencies"
    AS              PERMISSIVE
    FOR             SELECT
    TO              "public"
    USING (
...
-------------------------------------------------------------------------------
-- INSERT INTO "iso"."country_languages"
-------------------------------------------------------------------------------
INSERT INTO
...
-------------------------------------------------------------------------------
-- INSERT INTO "iso"."country_currencies"
-------------------------------------------------------------------------------
INSERT INTO
